...
import com.cc.aws.s3transferutility.Constants;
 ...
 /*
 * Copyright (c) 2018. Created by Mohanraj.S,Innobot Systems on 15/2/18 for DroidRepos
...
public class DownloadActivity extends ListActivity {
    ...
    private static final String TAG =String.class.getName();
    ...
    private Button btnDownload,btnPause,btnResume,btnCancel,btnDelete,btnPauseAll,btnCancelAll;
