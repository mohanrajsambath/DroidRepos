...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView imgVw_Btry_status;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgVw_Btry_status = (ImageView)findViewById(R.id.imgVw_Btry_status);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Displays Realtime Battery Statistic", Snackbar.LENGTH_LONG).show();
            }
        });
